...
import {
	...
	HStack, Input, StackDivider, VStack
...
export default function Configure() {
	...
	return (
		<Layout title="snips.to &middot; configure" height="100vh">
			<form onSubmit={handleSubmit(upload)} style={{ height: "100%" }}>
				<VStack style={{ height: "100%" }} spacing={5}>
					<FormControl isDisabled={streaming || isSubmitting}>
						<VStack alignItems="start" textAlign="left">
							...
							<FormHelperText>
								When enabled, your file will self-destruct once it is downloaded.
							</FormHelperText>
						</VStack>
					</FormControl>
					<Divider />
					<FormControl isDisabled={isSubmitting}>
						<VStack alignItems="start" textAlign="left">
							...
							<FormHelperText>
								When enabled, your upload will not be stored on the server. Instead,
								it will be streamed to the remote user when they begin downloading.
							</FormHelperText>
						</VStack>
					</FormControl>
					<Divider />
					...
					<FormControl isDisabled={isSubmitting}>
						<VStack alignItems="start" textAlign="left">
							...
							<FormHelperText>
								Enable a text-based password protection requirement before remote
								users can download your file.
							</FormHelperText>
						</VStack>
					</FormControl>
